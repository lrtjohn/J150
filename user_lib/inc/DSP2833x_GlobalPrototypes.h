...
extern void InitSysCtrl(void);//����2016.6.11yjs
...
extern void adc_init(void);//����2016.6.11yjs
extern void InitXintf(void);//����2016.6.11yjs
extern void InitEPwm1(void);//����2016.6.11yjs
extern void InitEPwm2(void);//����2016.6.11yjs
extern void InitEPwm3(void);
extern void scib_loopback_init(void);//����2016.6.11yjs
extern void scib_fifo_init(void);//����2016.6.11yjs
