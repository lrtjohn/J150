...
{
	Uint16 init     	: 1;/*0*/
	Uint16 busOV        : 1;/*1 暂未使用*/
	Uint16 busUV    	: 1;/*2*/
	Uint16 swbusOV      : 1;/*3*/
	Uint16 busCurrent	: 1;/*4*/
	Uint16 bridgeCurrent: 1;/*5*/
	Uint16 swbusCurrent : 1;/*6*/
	Uint16 bridgeSum    : 1;/*7*/
	Uint16 hw_I_zero    : 1;/*8*/
	Uint16 motortemp    : 1;/*9*/
	Uint16 drivertemp   : 1;/*10*/
	Uint16 overspeed   	: 1;/*11*/
	Uint16 hall_error	: 1;/*12*/
	Uint16 ctrlbusVolt 	: 1;/*13*/
	Uint16 ctrlbusCurr  : 1;/*14*/
	Uint16 pgVcc5V      : 1;/*15*/
	Uint16 pg1v9		: 1;/*16*/
	Uint16 pgVcc3V3  	: 1;/*17*/
	Uint16 pgVdd5V    	: 1;/*18*/
	Uint16 hw_anlg_lvl 	: 1;/*19 other ADs except 270V V and I*/
	Uint16 hardware		: 1;/*20*/
	Uint16 hw_digit_lvl	: 1;/*21*/
...
#define INIT_ALARM_MASK                             	BIT0
#define BUS_OVERVOLTAGE_ALARM_MASK                      BIT1
#define BUS_UNDERVOLTAGE_ALARM_MASK                    	BIT2
#define SW_BUS_OVER_VOLTAGE_ALARM_MASK                 	BIT3
#define BUS_CURRENT_ALARM_MASK                      	BIT4
#define BRIDGE_OVER_CURRENT_ALARM_MASK                  BIT5
#define BUS_OVER_CURRENT_ALARM_MASK                     BIT6
#define BRIDGE_CURRENT_SUM_ALARM_MASK                   BIT7
#define HW_CURRENT_ZERO_ALARM_MASK                      BIT8
#define MOTOR_TEMPERATURE_ALARM_MASK                    BIT9
#define DRIVER_TEMPERATURE_ALARM_MASK                   BIT10
#define MOTOR_OVER_SPEED_ALARM_MASK                   	BIT11
#define HALL_OUTOF_RANGE_ALARM_MASK                  	BIT12
#define CONTROL_VOLTAGE_ALARM_MASK               	    BIT13
#define CONTROL_CURRENT_ALARM_MASK              	    BIT14
#define POWER_GOOD_VCC5V_ALARM_MASK         		    BIT15
#define POWER_GOOD_1V9_ALARM_MASK              	    	BIT16
#define POWER_GOOD_VCC3V3_ALARM_MASK         		    BIT17
#define POWER_GOOD_VDD5V_ALARM_MASK						BIT18
#define HW_ANALOG_LEVEL_ALARM_MASK						BIT19
#define HARDWARE_ALARM_MASK								BIT20
#define HW_DIGITAL_LEVEL_ALARM_MASK						BIT21
#define SW_PWM_ISR_ALARM_MASK							BIT22
#define SOFTWARE_ALARM_MASK								BIT23
#define HW_DIGIT_SIGNAL_ALARM_MASK						BIT24
...
#define IS_MOTOR_TEMPERATURE_WARNING                    (gSysStateFlag.warning.bit.motortemp == 1)
...
#define IS_DRIVER_TEMPERATURE_WARNING                   (gSysStateFlag.warning.bit.drivertemp == 1)

#define SET_PAHSE_CHANGE_WARNING             			(gSysStateFlag.warning.bit.pahse_change = 1)
#define CLEAR_PAHSE_CHANGE_WARNING           			(gSysStateFlag.warning.bit.pahse_change = 0)
#define IS_PAHSE_CHANGE_WARNING          		   	 	(gSysStateFlag.warning.bit.pahse_change == 1)
